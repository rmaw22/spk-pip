                ...
                if (aspek) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(aspek, value) {
                                $('select[name="id_faktor"]').append('<option value="' +
                                    aspek + '">' + value + '</option>');
                            });
                        },
                        error: function(data) {
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group{!! $errors->has('nis') ? ' has-error' : '' !!}">
                            ...
                            <select name="nis" class="form-control" required="required" disabled>
                    ...
                    {{ Form::hidden('_method', 'delete') }} --}}
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tfoot>
                                <tr>
                                    <td align="center">
                                        {{ Form::button('<i class="glyphicon glyphicon-remove"></i>', ['class' => 'btn btn-danger btn-xs btn-del', 'type' => 'submit']) }}
                                    </td>
                                    <td colspan="5"></td>
                                    <!-- <td align="center">
