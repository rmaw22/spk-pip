...
<body class="skin-blue sidebar-mini">
    <div class="wrapper boxed-wrapper">
        <header class="main-header">
            ...
            <nav class="navbar blue-bg navbar-static-top">
                <img src="{{ asset('logo.jpg') }}" class="logo img-circle" alt=""
                    style="padding-top: 5px;padding-bottom: 5px">
                <span class="logo" style="color:white ; text-align:left;font-size:25px"> SMK Pembangunan
                    <!-- </h1> should be here -->
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        @else
                            <li class="dropdown user user-menu p-ph-res"> <a href="#" class="dropdown-toggle"
                                    data-toggle="dropdown"> <img src="{{ asset('logo.jpg') }}" class="user-image"
                                        alt="User Image" style="margin-bottom:10px;"> <span
                                        class="hidden-xs">{{ Auth::user()->name }}</span> </a>
                                <ul class="dropdown-menu">
                                    <li class="user-header">
                                        <div class="pull-left user-img"><img src="{{ asset('logo.jpg') }}"
                                                class="img-responsive img-circle" alt="User"></div>
                                        <p class="text-left">{{ Auth::user()->name }} <small>(2021)</small> </p>
                                    </li>
                                    <li><a href="{{ url('/settings/profile') }}"><i
                                                class="icon-profile-male"></i>Account Setting</a></li>
                                    <li><a href="{{ url('/settings/password') }}"><i class="icon-wallet"></i> Ubah
                                            Password</a></li>
                                    <!-- <li><a href="#"><i class="icon-envelope"></i> Inbox</a></li>
              <li role="separator" class="divider"></li>
              <li><a href="#"><i class="icon-gears"></i> Account Setting</a></li>
              <li role="separator" class="divider"></li> -->
                                    <li><a href="{{ url('/logout') }}"><i class="fa fa-power-off"></i> Sign Out</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
        ...
        <div class="main-nav" style="margin-bottom:20px">
            <nav>
                ...
                <ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
                    ...
                    @else
                        <li><a href="{{ url('/') }}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a>
                        </li>
                        @if (Auth::user()->id_role == 1)
                            <li><a href="{{ route('siswa.index') }}"> <i class="fa fa-user"></i> <span> Siswa
                                    </span></a></li>
                            <li><a href="{{ route('aspek.index') }}"> <i class="fa fa-object-group"></i> <span>
                                        Kriteria </span></a></li>
                            <li><a href="{{ route('faktor.index') }}"> <i class="fa fa-object-ungroup"></i> <span>
                                        Sub Kriteria </span></a></li>
                            <li><a href="{{ route('nilai.index') }}"> <i class="fa fa-star"></i> <span> Nilai Siswa
                                    </span></a></li>
                            <li><a href="{{ route('gap.index') }}"> <i class="fa fa-sliders"></i> <span> GAP
                                    </span></a></li>
                        @endif
                        <li><a href="{{ route('hasil.index') }}"> <i class="fa fa-list-alt"></i> <span> Result
                                </span></a></li>
                        <li style="float:right"><a href="{{ url('/logout') }}"> <i class="fa fa-power-off"></i>
    ...
    <div class="content"> --}}
        ...
        <footer>
            ...
            Copyright © 2021 | SPK PIP. All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
