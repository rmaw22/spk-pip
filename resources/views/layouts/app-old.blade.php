        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                        <li><a href="{{ route('karyawan.index') }}">Siswa</a></li>
                        <li><a href="{{ route('aspek.index') }}">Kriteria</a></li>
                        <li><a href="{{ route('faktor.index') }}">Sub Kriteria</a></li>                       
                        <li><a href="{{ route('nilai.index') }}">Nilai Siswa</a></li>
                        <li><a href="{{ route('gap.index') }}">GAP</a></li>
                        <li><a href="{{ route('hasil.index') }}">Result</a></li>
                        <li><a href="{{ route('manager.index') }}">Kepala Bidang</a></li>
                        <li class="dropdown">
