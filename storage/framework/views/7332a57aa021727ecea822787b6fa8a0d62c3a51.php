            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group<?php echo $errors->has('periode') ? ' has-error' : ''; ?>">
                        ...
                        <?php /* Form::selectYear('periode', date("Y", strtotime('-50 years')), date("Y", strtotime('+3 years')),  date('Y'),['class' => 'form-control', 'placeholder' => 'Masukkan Tahun Periode', '']) */ ?>
                        <input type="text" class="form-control allownumericwithoutdecimal" name="periode" id="datepicker" placeholder="Masukkan Tahun Periode" />
