        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php echo e(Form::open(['route' => 'karyawan.store'])); ?>

                        <div class="form-group<?php echo $errors->has('id_karyawan') ? ' has-error' : ''; ?>">
                            <?php echo e(Form::label('id_karyawan', 'NIS*')); ?>

                            <?php echo e(Form::text('id_karyawan', null, ['class'=>'form-control', 'placeholder'=>'e.g 10119479', 'required', 'oninvalid' => 'this.setCustomValidity("NIS Harus Diisi")', 'onchange' => 'this.setCustomValidity("")', 'maxlength' => '8'])); ?>
