        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php echo e(Form::model($karyawans, ['route'=>['karyawan.update', $karyawans->id_karyawan], 'method'=>'PATCH'])); ?>   
                        <div class="form-group<?php echo $errors->has('id_karyawan') ? ' has-error' : ''; ?>">
                            <?php echo e(Form::label('id_karyawan', 'ID Karyawan')); ?>

                            <?php echo e(Form::text('id_karyawan', null, ['class'=>'form-control', 'placeholder'=>'Masukkan ID Karyawan', 'required', 'oninvalid' => 'this.setCustomValidity("ID Karyawan Harus Diisi")', 'onchange' => 'this.setCustomValidity("")', 'maxlength' => '8'])); ?>

                            <?php echo $errors->first('id_karyawan', '<p class="help-block">:message</p>'); ?>

                        </div>
                        <div class="form-group<?php echo $errors->has('nama') ? ' has-error' : ''; ?>">
                            <?php echo e(Form::label('nama', 'Nama Karyawan')); ?>
                        ...
                        <div class="form-group<?php echo $errors->has('agama') ? ' has-error' : ''; ?>">
                            ...
                            <select name="agama" class="form-control" required="required">
                                <?php if($karyawans->agama == 'Islam'): ?>
                                <option value="Islam">Islam</option>
                                <option value="Kristen">Kristen</option>
                                <option value="Katolik">Katolik</option>
                                <option value="Hindu">Hindu</option>
                                <option value="Budha">Budha</option>
                                <?php elseif($karyawans->agama == 'Kristen'): ?>
                                <option value="Kristen">Kristen</option>
                                <option value="Islam">Islam</option>
                                <option value="Katolik">Katolik</option>
                                <option value="Hindu">Hindu</option>
                                <option value="Budha">Budha</option>
                                <?php elseif($karyawans->agama == 'Katolik'): ?>
                                <option value="Katolik">Katolik</option>
                                <option value="Islam">Islam</option>
                                <option value="Kristen">Kristen</option>
                                <option value="Hindu">Hindu</option>
                                <option value="Budha">Budha</option>
                                <?php elseif($karyawans->agama == 'Hindu'): ?>
                                <option value="Hindu">Hindu</option>
                                <option value="Katolik">Katolik</option>
                                <option value="Islam">Islam</option>
                                <option value="Kristen">Kristen</option>
                                <option value="Budha">Budha</option>
                                <?php elseif($karyawans->agama == 'Budha'): ?>
                                <option value="Budha">Budha</option>
                                <option value="Katolik">Katolik</option>
                                <option value="Islam">Islam</option>
                                <option value="Kristen">Kristen</option>
