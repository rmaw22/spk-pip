...
//  dd($Nilai_total);
        ...
        // dd($get_tahun);
        return view('adminpanel.hasil.index', compact ('get_tahun','managers', 'result', 'result1', 'result2' ,'result3','Nilai_total'));
    }
...
//  dd($Nilai_total);
        ...
        $managers = [
         ...
         // $managers = Manager::select('nip','nama')->first();
        // dd($get_tahun);
        return view('adminpanel.hasil.hasilByYear', compact ('periode','managers', 'result', 'result2' ,'result3','Nilai_total'));
